...
На работу ушло примерно 6 часов. 
...
Можно было бы еще распарсить json-файл и сделать запрос по каждой вакансии, и записать эту информацию в отдельные файлы, в "читабельном" виде.
